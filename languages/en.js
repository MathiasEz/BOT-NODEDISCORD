const enLang = {
  ...
  volumeAlertMessage:
    "- This command can only be used through slash command!\n- Please use `/volume` to control volume.",
  // beautiful.js
  ...
  dmReceivedDescription:
    "Hello! You've received a message from ${sender} in ${interaction.guild.name}. Reason: ${reason}",
