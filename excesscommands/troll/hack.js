...
async function simulateHackingProcess(message, target, initialReply) {
  ...
  await initialReply.edit({
    content: `Mission complete! I've successfully hacked **${target}** devices, and exposed everything!`,
  })
  ...
  const embed = new EmbedBuilder()
    .setAuthor({
      ...
      name: `${message.client.user.username} Hacking System`,
    })
    .setColor("#0099ff")
