...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((sub) => sub.setName("blush").setDescription("Blush action!"))
    // Subcommand for bonk (requires a target)
    .addSubcommand((sub) =>
      sub
        .setName("bonk")
        .setDescription("Bonk someone!")
        .addUserOption((option) => option.setName("user").setDescription("The user to bonk").setRequired(true)),
    )
    // Subcommand for bored (no target)
    .addSubcommand((sub) => sub.setName("bored").setDescription("Bored action!"))
    // Subcommand for bully (requires a target)
    .addSubcommand((sub) =>
      sub
        .setName("bully")
        .setDescription("Bully someone!")
        .addUserOption((option) => option.setName("user").setDescription("The user to bully").setRequired(true)),
    )
    // Subcommand for cry (no target)
    .addSubcommand((sub) => sub.setName("cry").setDescription("Cry action!"))
    ...
    .addSubcommand((sub) => sub.setName("dance").setDescription("Dance like nobody's watching!"))
    ...
    .addSubcommand((sub) => sub.setName("nervous").setDescription("Feeling nervous!"))
    ...
    .addSubcommand((sub) => sub.setName("scream").setDescription("Scream action!"))
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addUserOption((option) => option.setName("user").setDescription("The user to wave at").setRequired(true)),
    )
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addUserOption((option) => option.setName("user").setDescription("The user to wink at").setRequired(true)),
    ),
  ...
  async execute(interaction) {
    if (interaction.isCommand && interaction.isCommand()) {
      ...
      try {
        ...
        const embed = new EmbedBuilder().setColor("#ffcc00").setDescription(description).setImage(gif).setTimestamp()
