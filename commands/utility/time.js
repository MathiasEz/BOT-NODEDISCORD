    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addIntegerOption((option) =>
          option.setName("minutes").setDescription("Time duration for the timer in minutes.").setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addIntegerOption((option) =>
          option.setName("minutes").setDescription("Time duration for the reminder in minutes.").setRequired(true),
        )
        .addStringOption((option) =>
          option.setName("task").setDescription("Task to be reminded about.").setRequired(true),
        ),
    ),
