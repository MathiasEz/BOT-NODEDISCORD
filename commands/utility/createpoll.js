...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addIntegerOption((option) =>
      option.setName("options").setDescription("The number of options (1-6)").setRequired(true),
    )
    .addChannelOption((option) =>
      option.setName("channel").setDescription("The channel to send the poll to").setRequired(true),
    )
    .addStringOption((option) => option.setName("option1").setDescription("First option").setRequired(false))
    .addStringOption((option) => option.setName("option2").setDescription("Second option").setRequired(false))
    ...
    .addStringOption((option) => option.setName("option6").setDescription("Sixth option").setRequired(false)),
