  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((option) =>
          option.setName("roleid").setDescription("The ID of the role to be assigned").setRequired(true),
        )
        .addBooleanOption((option) =>
          option.setName("status").setDescription("The status of the auto-role").setRequired(true),
        ),
    )
