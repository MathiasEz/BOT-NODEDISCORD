    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addBooleanOption((option) =>
          option.setName("active").setDescription("Activate the sticky message? (true/false)").setRequired(true),
        )
        .addChannelOption((option) =>
          option.setName("channel").setDescription("Select the channel for the sticky message").setRequired(true),
        )
        ...
        .addStringOption((option) =>
          option.setName("title").setDescription("Title of the embed (optional)").setRequired(false),
        )
        .addStringOption((option) =>
          option.setName("description").setDescription("Description of the embed (optional)").setRequired(false),
        )
        .addStringOption((option) =>
          option.setName("footer").setDescription("Footer text of the embed (optional)").setRequired(false),
        )
        .addStringOption((option) =>
          option.setName("image").setDescription("Image URL for the embed (optional)").setRequired(false),
        )
        .addStringOption((option) =>
          option.setName("thumbnail").setDescription("Thumbnail URL for the embed (optional)").setRequired(false),
        ),
    )

    .addSubcommand((sub) => sub.setName("view").setDescription("View all sticky messages set for this server."))
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addIntegerOption((option) =>
          option.setName("index").setDescription("The index of the sticky message to delete").setRequired(true),
        ),
    ),
