  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((option) =>
          option.setName("prefix").setDescription("Set the server prefix").setRequired(false),
        ),
    )
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((option) =>
          option
            .setName("removebotmanagers")
            .setDescription("Comma-separated list of user IDs to remove from bot managers")
            .setRequired(false),
        )
        .addBooleanOption((option) =>
          option.setName("resetprefix").setDescription("Reset the prefix to default").setRequired(false),
        ),
    ),
