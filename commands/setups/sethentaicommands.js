    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addBooleanOption((option) =>
          option.setName("status").setDescription("Enable (true) or disable (false) hentai commands").setRequired(true),
        ),
    )
    // Subcommand to view the current configuration.
    .addSubcommand((sub) => sub.setName("view").setDescription("View the current hentai commands configuration")),
