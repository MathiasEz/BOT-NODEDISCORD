    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addChannelOption((option) =>
          option.setName("discord_channel").setDescription("The Discord channel for notifications.").setRequired(true),
        )
        ...
        try {
          ...
          const embed = new EmbedBuilder()
            ...
            .addFields(
              ...
              {
                name: "Mention Roles",
                value: mentionRoles.length > 0 ? mentionRoles.map((role) => `<@&${role}>`).join(", ") : "None",
              },
            )
            .setColor("#00FF00")
