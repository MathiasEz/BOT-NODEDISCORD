  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addChannelOption((option) =>
          option.setName("channel").setDescription("Select the channel for the counting game.").setRequired(true),
        )
        .addBooleanOption((option) =>
          option.setName("status").setDescription("Enable or disable counting.").setRequired(true),
        ),
    )

    .addSubcommand((sub) => sub.setName("view").setDescription("View the current count."))
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addChannelOption((option) =>
          option.setName("channel").setDescription("Select a new counting channel.").setRequired(true),
        ),
    )
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addIntegerOption((option) =>
          option.setName("count").setDescription("Set the current count.").setRequired(true),
        ),
    ),
  ...
  async execute(interaction) {
    if (interaction.isCommand && interaction.isCommand()) {
      ...
      if (subcommand === "edit") {
        ...
        await countingCollection.updateOne({ guildId }, { $set: { channelId: newChannel.id } })
      ...
      if (subcommand === "update") {
        ...
        await countingCollection.updateOne({ guildId }, { $set: { currentCount: newCount } })
