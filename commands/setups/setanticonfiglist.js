  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option.setName("values").setDescription("Comma-separated list of values to add").setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
  ...
  async execute(interaction) {
    if (interaction.isCommand && interaction.isCommand()) {
      ...
      if (subcommand === "add") {
        if (
          ![
            "whitelisted_antilink_channels",
            "whitelisted_antilink_types",
            "whitelisted_antispam_channels",
            "blocked_words",
          ].includes(type)
        ) {
        ...
        const updatedValues =
          existingData && existingData[type] ? [...new Set([...existingData[type], ...values])] : values
