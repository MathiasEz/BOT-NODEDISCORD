  ...
  async execute(interaction) {
    ...
    try {
      ...
      if (voiceChannelSetup) {
        ...
        mainEmbed.addFields({
          name: "Voice Channel Setup",
          value: "No voice channel setups found for this server.",
          inline: false,
        })
      }
      ...
      if (autoroleSetup) {
        ...
        mainEmbed.addFields({
          name: "Auto-Role Setup",
          value: "No auto-role setups found for this server.",
          inline: false,
        })
      }
      ...
      if (activeGiveaways.length > 0) {
        mainEmbed.addFields({ name: "Active Giveaways", value: `Current number of giveaways: **${giveawayCount}**` })
      } else {
      ...
      if (antiSetup) {
        const antiEmbed = new EmbedBuilder()
          ...
          .addFields(
            ...
            {
              name: "Time Window",
              value: antiSetup.antiSpam?.timeWindow ? `${antiSetup.antiSpam.timeWindow / 1000} seconds` : "N/A",
              inline: true,
            },
            { name: "Action", value: antiSetup.antiSpam?.action || "N/A", inline: true },
            {
              name: "Duration",
              value: antiSetup.antiSpam?.duration ? `${antiSetup.antiSpam.duration / 1000} seconds` : "N/A",
              inline: true,
            },
            ...
            {
              name: "Link Interval",
              value: antiSetup.antiLink?.linkInterval ? `${antiSetup.antiLink.linkInterval / 1000} seconds` : "N/A",
              inline: true,
            },
            ...
            { name: "Anti-Nuke", value: antiSetup.antiNuke?.enabled ? "Enabled" : "Disabled", inline: true },
            {
              ...
              value: antiSetup.antiNuke?.channelDeleteLimit?.toString() || "N/A",
              inline: true,
            },
            {
              name: "Channel Delete Time",
              value: antiSetup.antiNuke?.channelDeleteTime
                ? `${antiSetup.antiNuke.channelDeleteTime / 1000} seconds`
                : "N/A",
              inline: true,
            },
            {
              name: "Member Kick Limit",
              value: antiSetup.antiNuke?.memberKickLimit?.toString() || "N/A",
              inline: true,
            },
            ...
            {
              name: "Time Window",
              value: antiSetup.antiRaid?.timeWindow ? `${antiSetup.antiRaid.timeWindow / 1000} seconds` : "N/A",
              inline: true,
            },
        ...
        embeds.push(
          new EmbedBuilder()
            .setColor(0x0099ff)
            .setTitle("Anti-Setup Details")
            .setDescription("No anti-setup configurations found for this server."),
        )
      }
