    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addChannelOption((option) =>
          option.setName("channel").setDescription("Select the channel.").setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addIntegerOption((option) =>
          option.setName("duration").setDescription("Duration in seconds (0-21600).").setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand.setName("removeslowmode").setDescription("Remove slowmode from the channel."),
    )
    .addSubcommand((subcommand) => subcommand.setName("lock").setDescription("Lock the channel to prevent messages."))
    .addSubcommand((subcommand) =>
      subcommand.setName("unlock").setDescription("Unlock the channel to allow messages again."),
    ),
