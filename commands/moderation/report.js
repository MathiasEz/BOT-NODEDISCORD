    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addUserOption((option) =>
          option.setName("user").setDescription("The user whose reports you want to view.").setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addUserOption((option) =>
          option.setName("user").setDescription("The user whose reports you want to clear.").setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addUserOption((option) =>
          option.setName("user").setDescription("The user whose report you want to remove.").setRequired(true),
        )
        .addIntegerOption((option) =>
          option.setName("index").setDescription("The index of the report to remove.").setRequired(true),
        ),
    ),
      ...
      if (subcommand === "add") {
        ...
        if (index < 0 || index >= reports.reports.length) {
          return interaction.editReply({
            content: `❌ Invalid index. Use **/report list** to view valid report indexes.`,
          })
        }
