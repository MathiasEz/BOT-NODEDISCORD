    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addIntegerOption((option) =>
          option.setName("count").setDescription("Number of messages to delete (1-100).").setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addUserOption((option) =>
          option.setName("user").setDescription("User whose messages will be deleted.").setRequired(true),
        )
        .addIntegerOption((option) =>
          option.setName("count").setDescription("Number of messages to delete (1-100).").setRequired(true),
        ),
