  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addUserOption((option) =>
          option.setName("target").setDescription("User to give the role to.").setRequired(true),
        )
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addUserOption((option) =>
          option.setName("target").setDescription("User to remove the role from.").setRequired(true),
        )
    ...
    if (interaction.isCommand && interaction.isCommand()) {
      ...
      if (subcommand === "add") {
        ...
        if (roleType === "moderator") {
          ...
          rolePermissions = [PermissionFlagsBits.ModerateMembers]
        }
