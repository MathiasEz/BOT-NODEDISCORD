...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    // Subcommand: ping
    .addSubcommand((subcommand) => subcommand.setName("ping").setDescription(lang.pingDescription))
    // Subcommand: invite
    .addSubcommand((subcommand) => subcommand.setName("invite").setDescription(lang.inviteDescription))
    // Subcommand: support
    .addSubcommand((subcommand) => subcommand.setName("support").setDescription(lang.supportDescription)),
