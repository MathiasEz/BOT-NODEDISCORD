  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option.setName("name").setDescription("The name of the application.").setRequired(true).setMaxLength(30),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option.setName("name").setDescription("The name of the application.").setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option.setName("appname").setDescription("The application name.").setRequired(true),
        )
        .addStringOption((option) =>
          option
            .setName("question")
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addIntegerOption((option) =>
          option.setName("index").setDescription("The question index to remove.").setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addChannelOption((option) =>
          option.setName("channel").setDescription("The main channel for applications.").setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addChannelOption((option) =>
          option.setName("channel").setDescription("The response channel for application reviews.").setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand.setName("show").setDescription("Show all applications and their details."),
    ),
    ...
    if (interaction.isCommand && interaction.isCommand()) {
      ...
      if (subcommand === "create") {
        ...
        const embed = new EmbedBuilder()
          ...
          .setColor("Blue")
          .setAuthor({
            name: "Welcome To Our Application System",
            iconURL: "https://cdn.discordapp.com/emojis/1052751247582699621.gif",
          })
          .setFooter({
            text: "Thank you for your interest!",
            iconURL: "https://cdn.discordapp.com/emojis/798605720626003968.gif",
          })
        ...
        const applicationDetails = applications.map((app, index) => {
          ...
          const questions =
            app.questions.length > 0 ? app.questions.map((q, i) => `${i + 1}. ${q}`).join("\n") : "No questions added."
