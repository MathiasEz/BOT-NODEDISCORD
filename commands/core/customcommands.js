...
const { createOrUpdateCommand, deleteCommand, getUserCommands } = require("../../models/customCommands")
  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) => option.setName("name").setDescription("The command name.").setRequired(true)),
    )
    .addSubcommand((subcommand) => subcommand.setName("show").setDescription("Show all custom commands you created."))
    .addSubcommand((subcommand) =>
      subcommand.setName("audit").setDescription("List all custom commands (Admin only)."),
    ),
