    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addUserOption((option) =>
          option.setName("user").setDescription("The user whose birthday you want to check.").setRequired(false),
        ),
    )
    .addSubcommand((subcommand) => subcommand.setName("remove").setDescription("Remove your birthday from the system."))
    .addSubcommand((subcommand) =>
      subcommand.setName("upcoming").setDescription("Check upcoming birthdays in the next 30 days."),
    ),
          ...
          return interaction.editReply({
            embeds: [
              new EmbedBuilder()
                ...
                .setDescription(
                  "Please provide your birthday in **MM-DD** format (e.g., **12-25** for December 25th).",
                ),
            ],
          })
        }
